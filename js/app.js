(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".production__galere-block")) {
            let thumbsSwiper = new core(".foot-prodaction__slider", {
        ...
        if (document.querySelector(".hero-card-pg__images")) {
            let thumbsSwiper = new core(".image-product__slider", {
                modules: [ Navigation, Thumb, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            new core(".image-preview__slider", {
                ...
                pagination: {
                    el: ".image-preview-swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".image-preview-swiper-button-prev",
                    nextEl: ".image-preview-swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1,
        ...
        if (document.querySelector(".reviews-pg__slider")) new core(".reviews-pg__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.3,
...
***************************************************************************** */
    ...
    for (let i = 0; i < script_link.length; i++) if (url == script_link[i].href) script_link[i].classList.add("active");
    window["FLS"] = true;
    isWebp();
    addTouchClass();
    menuInit();
